...
import { Homework, HomeworkCreatePayload } from '@app/features/homework/homeworkModel';

export const homeworkHandlers = [
    // create homework 
    http.post<any, HomeworkCreatePayload>(`${appPaths.basePath}${appPaths.homeworkCreate}`, 
    async (info) => {
        try {
