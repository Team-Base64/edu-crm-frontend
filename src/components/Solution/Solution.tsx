...
const Solution: React.FC<SolutionProps> = ({ id, classes }) => {
    const { data, isLoading, isError, isSuccess } = useGetSolutionQuery({ id: id });
    ...
    return (
        <Container direction='vertical' layout='defaultBase' gap="l" classes={[styles.widget, classes].join(' ')}>
